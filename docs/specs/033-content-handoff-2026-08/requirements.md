...
**R1 — Copy Tea/Tai Chi/Yin & Yang.** GIVEN a LP THEN cada bloco exibe a versão *short* e a *body copy* exatas do handoff, em inglês, sem paráfrase.
...
**R4 — Services (tabela principal).** GIVEN a seção de preços THEN as 3 tiers (Tasting / Yin & Yang / Extended Workshop) aparecem com *what's included*, group size, duração e preço, mais a linha de **add-ons** como nota de rodapé. Responsiva: vira cards empilhados no celular, sem scroll horizontal.
