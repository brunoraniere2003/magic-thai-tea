...
> Atualizado pelo **ADR 0017** (2026-09-20): entra a **loja** (10 links da Stripe) — a LP passa a ter **duas** conversões, o contato (principal) e a compra de chá (upsell depois da prova social). Reservar serviço **nunca** vira botão de checkout.
