...
| 033 | content-handoff-2026-08   | 🟡 in progress (PR aberto)      | 028, 030 · ADR 0012/0014 |
| 034 | handoff-v2-loja-e-precos  | 🟡 in progress (loja feita)     | 033 · ADR 0017 |
...
> **Docs vivas:** `../methodology.md` (práticas e ciclo) · `../CHANGELOG.md` (diário) · `../blockers.md` (pendências externas B1–B17).
